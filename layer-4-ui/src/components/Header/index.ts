...
export class Header {
  ...
  private _projectZone!:  HTMLElement
   ...
   */
  private _syncProject(): void {
    const graph = store.graph
    const projectPath = (graph as any).meta?.projectPath as string | undefined
    ...
    if (hasProject) {
      ...
      editBtn.addEventListener('click', () => emit('project:pick:show', undefined as any))
      ...
      connectBtn.addEventListener('click', () => emit('project:pick:show', undefined as any))
